...
public class CSEBaseManager extends AbsManager {
	...
	public void createIfNotExist() throws OneM2MException {
		...
		if (csebase == null) {
			...
			csebase.addSupportedResourceType(RESOURCE_TYPE.FLEXCONTAINER.Value());						// added in 2017-03-13, blocked in 2017-10-24 for TTA, unblocked in the 2017-11-17
			csebase.addSupportedResourceType(RESOURCE_TYPE.SCHEDULE.Value());						// added in 2017-03-13
			csebase.addSupportedResourceType(RESOURCE_TYPE.NOTIFICATIONTARGETPOLICY.Value());		// added in 2017-03-13, blocked in 2017-10-24 for TTA, unblocked in the 2017-11-17
			csebase.addSupportedResourceType(RESOURCE_TYPE.TIMESERIES.Value());						// added in 2017-11-17
			csebase.addSupportedResourceType(RESOURCE_TYPE.TIMESERIESINSTANCE.Value());				// added in 2017-11-17
