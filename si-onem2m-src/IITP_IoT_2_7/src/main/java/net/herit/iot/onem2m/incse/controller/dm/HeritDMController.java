...
public class HeritDMController implements DMControllerInterface {
	...
	@Override
	public Software executeMgmtObj(Software swInDB, Software software) throws OneM2MException {
		throw new OneM2MException(RESPONSE_STATUS.NOT_IMPLEMENTED, "getStatus Not implemented for mgmtObj:"+swInDB.getMgmtDefinition());
	}
