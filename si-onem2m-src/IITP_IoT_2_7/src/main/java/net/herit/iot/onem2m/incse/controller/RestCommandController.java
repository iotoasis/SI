	...
	public OneM2mResponse addTr69DMResource(HashMap<String, Object> paramMap) {
		...
		try {
			...
			try {
				...
				} else if(paramMap.get(MOUri.DVC_BATTERY_LEVEL) != null && paramMap.get(MOUri.DVC_BATTERY_STATUS) != null) {
					//battery
				...
				} else if(paramMap.get(MOUri.DVC_EVT_LOG_TYPE_ID) != null && paramMap.get(MOUri.DVC_EVT_LOG_DATA) != null
