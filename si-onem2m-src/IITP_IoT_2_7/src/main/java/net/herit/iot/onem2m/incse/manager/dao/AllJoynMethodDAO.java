...
public class AllJoynMethodDAO extends ResourceDAO implements DAOInterface {
	
	private Logger log = LoggerFactory.getLogger(AllJoynMethodDAO.class);

	public AllJoynMethodDAO(OneM2mContext context) {
		super(context);
	}
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			DaoJSONConvertor<AllJoynMethod> jc = (DaoJSONConvertor<AllJoynMethod>)ConvertorFactory.getDaoJSONConvertor(AllJoynMethod.class, AllJoynMethod.SCHEMA_LOCATION);
			return jc.marshal((AllJoynMethod)res);
	...
	public void create(Resource resource) throws OneM2MException {
		...
		((AllJoynMethod) resource).setStateTag(0);
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		...
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, 
				ConvertorFactory.getDaoJSONConvertor(AllJoynMethod.class, AllJoynMethod.SCHEMA_LOCATION), rc);
