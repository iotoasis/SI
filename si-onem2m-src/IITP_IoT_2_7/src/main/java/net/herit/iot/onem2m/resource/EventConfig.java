...
@XmlRootElement(name = Naming.EVENTCONFIG_SN)
...
//	public static final String SCHEMA_LOCATION = "CDT-eventConfig-v1_6_0.xsd";
	public static final String SCHEMA_LOCATION = "CDT-eventConfig-v2_7_0.xsd";
    ...
    //@XmlElement(required = true)
    @XmlElement(name = Naming.EVENTTYPE_SN)
    protected Integer eventType;
    @XmlElement(name = Naming.EVENTSTART_SN)
    protected String eventStart;
    @XmlElement(name = Naming.EVENTEND_SN)
    protected String eventEnd;
    @XmlElement(name = Naming.OPERATIONTYPE_SN)
    @XmlList
    protected List<Integer> operationType;
    @XmlElement(name = Naming.DATASIZE_SN)
...
//    	}
	...
	public void validate(OPERATION operation) throws OneM2MException {
		...
		//	}
			...
			if (this.eventID != null) {				
				throw new OneM2MException(RESPONSE_STATUS.INVALID_ARGUMENTS, "eventID is NP on UPDATE");				
			}
