...
public class CoapAbsCodec {
	public enum COAP_CONTENT_TYPE {
		...
		RES_CBOR(10010, CONTENT_TYPE.RES_CBOR),	// added in 2017-05-12
		NTFY_XML(10002, CONTENT_TYPE.NTFY_XML),
		NTFY_JSON(10003, CONTENT_TYPE.NTFY_JSON),
		NTFY_CBOR(10011, CONTENT_TYPE.NTFY_CBOR),	// added in 2017-05-12
...
//		PREQ_CBOR(10012, CONTENT_TYPE.PREQ_CBOR),	// added in 2017-05-12			
//		PRSP_XML(10008, CONTENT_TYPE.PRSP_XML),
//		PRSP_JSON(10009, CONTENT_TYPE.PSRP_JSON),
//		PRSP_CBOR(10013, CONTENT_TYPE.PRSP_CBOR);	// added in 2017-05-12
