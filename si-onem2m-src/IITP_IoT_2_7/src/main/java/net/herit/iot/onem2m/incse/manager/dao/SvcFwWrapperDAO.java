...
public class SvcFwWrapperDAO extends ResourceDAO implements DAOInterface {
	
	private Logger log = LoggerFactory.getLogger(SvcFwWrapperDAO.class);

	public SvcFwWrapperDAO(OneM2mContext context) {
		super(context);
	}
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			DaoJSONConvertor<SvcFwWrapper> jc = (DaoJSONConvertor<SvcFwWrapper>)ConvertorFactory.getDaoJSONConvertor(SvcFwWrapper.class, SvcFwWrapper.SCHEMA_LOCATION);
			return jc.marshal((SvcFwWrapper)res);
	...
	public void create(Resource resource) throws OneM2MException {
		...
		((SvcFwWrapper) resource).setStateTag(0);
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		...
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, 
				ConvertorFactory.getDaoJSONConvertor(SvcFwWrapper.class, SvcFwWrapper.SCHEMA_LOCATION), rc);
