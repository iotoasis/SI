...
//		resMessage.setEventCategory(reqMessage.getEventCategory());
	 ...
	 * @return
	 */
	public void processRequest(OneM2mRequest reqMessage, String clientIp) {
		...
		try {
			...
			reqMessage.setOriginator(OneM2mUtil.createOriginator(reqMessage, this.context, clientIp));
...
//		
	...
	private String getForwardingUriIfNeeded(String to) throws OneM2MException {
		...
		} else if(Utils.checkIfUnstructuredCseRelative(to)) {	// added in 2017-10-18 to support unstructured CSE-relative addressing mode
			return null;
		} else {
