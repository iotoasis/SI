...
public class DaoJSONConvertor<T> {
	
	private final Class<T> t;
	private JAXBContext context;
	private Unmarshaller um;
	private Marshaller m;
	private Logger log = LoggerFactory.getLogger(DaoJSONConvertor.class);
	...
	public DaoJSONConvertor(Class<T> type) {
		this.t = type;
...
//	public DaoJSONConvertor(Class<T> type, boolean isJsonIncludeRoot) {
//		this.t = type;
//
//		Map<String, Object> properties = new HashMap<String, Object>(3);
//		properties.put(JAXBContextProperties.OXM_METADATA_SOURCE, "net/herit/iot/onem2m/resource/oxm.xml");
...
//			//System.out.println("json: " + json);
			...
			DaoJSONConvertor<AE> JC2 = new DaoJSONConvertor<AE>(AE.class);
			...
			DaoJSONConvertor<AE> JC3 = new DaoJSONConvertor<AE>(AE.class);
