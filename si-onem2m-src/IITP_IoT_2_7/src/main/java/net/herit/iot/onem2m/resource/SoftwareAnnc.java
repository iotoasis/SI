...
@XmlRootElement(name = Naming.SOFTWAREANNC_SN)
...
//	public final static String SCHEMA_LOCATION = "CDT-software-v1_6_0.xsd";
	public final static String SCHEMA_LOCATION = "CDT-software-v2_7_0.xsd";
    ...
    //@XmlElement(name = "URL")
    @XmlElement(name = Naming.URL_SN)
    @XmlSchemaType(name = "anyURI")
    protected String url;
    @XmlElement(name = Naming.INSTALL_SN)
    protected Boolean install;
    @XmlElement(name = Naming.UNINSTALL_SN)
    protected Boolean uninstall;
    @XmlElement(name = Naming.INSTALLSTATUS_SN)
    protected ActionStatus installStatus;
    @XmlElement(name = Naming.ACTIVATE_SN)
    protected Boolean activate;
    @XmlElement(name = Naming.DEACTIVATE_SN)
    protected Boolean deactivate;
    @XmlElement(name = Naming.ACTIVESTATUS_SN)
