...
//	public final static String SCHEMA_LOCATION = "CDT-cmdhBuffer-v1_6_0.xsd";
	public final static String SCHEMA_LOCATION = "CDT-cmdhBuffer-v2_7_0.xsd";
    ...
    //@XmlElement(required = true)
    @XmlElement(name = Naming.MAXBUFFERSIZE_SN, required = true)
    @XmlSchemaType(name = "nonNegativeInteger")
    protected Integer maxBufferSize;
    @XmlElement(name = Naming.STORAGEPRIORITY_SN)
