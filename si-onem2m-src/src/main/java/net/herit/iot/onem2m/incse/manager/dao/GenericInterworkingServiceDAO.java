...
public class GenericInterworkingServiceDAO extends ResourceDAO implements DAOInterface {

	private Logger log = LoggerFactory.getLogger(GenericInterworkingServiceDAO.class);
	
	public GenericInterworkingServiceDAO(OneM2mContext context) {
		super(context);
	}
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			DaoJSONConvertor<GenericInterworkingService> jc = (DaoJSONConvertor<GenericInterworkingService>)ConvertorFactory.getDaoJSONConvertor(GenericInterworkingService.class, GenericInterworkingService.SCHEMA_LOCATION);
			return jc.marshal((GenericInterworkingService)res);
	...
	public void create(Resource resource) throws OneM2MException {
		...
		((GenericInterworkingService) resource).setStateTag(0);
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		...
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, 
				ConvertorFactory.getDaoJSONConvertor(GenericInterworkingService.class, GenericInterworkingService.SCHEMA_LOCATION), rc);
