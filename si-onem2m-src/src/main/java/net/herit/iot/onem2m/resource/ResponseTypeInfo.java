...
public class ResponseTypeInfo {
	...
	@XmlElement(name = Naming.RESPONSETYPEVALUE_SN)
    protected Integer responseTypeValue;
    @XmlElement(name = "nu")
     ...
     *     
     */
    public Integer getResponseTypeValue() {
     ...
     *     
     */
    public void setResponseTypeValue(Integer value) {
