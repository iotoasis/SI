...
public class MgmtDeviceCapabilityDAO extends ResourceDAO implements DAOInterface {
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			JSONConvertor<DeviceCapability> jc = (JSONConvertor<DeviceCapability>)ConvertorFactory.getJSONConvertor(DeviceCapability.class, DeviceCapability.SCHEMA_LOCATION);
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		...
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, 
				(JSONConvertor<DeviceCapability>)ConvertorFactory.getJSONConvertor(DeviceCapability.class, DeviceCapability.SCHEMA_LOCATION), rc);
