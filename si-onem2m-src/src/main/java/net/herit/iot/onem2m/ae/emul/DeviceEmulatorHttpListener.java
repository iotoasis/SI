...
public class DeviceEmulatorHttpListener implements HttpServerListener {
	...
	public DeviceEmulatorHttpListener(String ip, int port, AEController aeController, NotiHandlerInterface notiHandler) {
		try {
