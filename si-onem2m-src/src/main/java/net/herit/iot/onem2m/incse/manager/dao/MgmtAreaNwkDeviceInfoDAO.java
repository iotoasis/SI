...
public class MgmtAreaNwkDeviceInfoDAO extends ResourceDAO implements DAOInterface {
	
	private Logger log = LoggerFactory.getLogger(MgmtAreaNwkDeviceInfoDAO.class);

	public MgmtAreaNwkDeviceInfoDAO(OneM2mContext context) {
		super(context);
	}
