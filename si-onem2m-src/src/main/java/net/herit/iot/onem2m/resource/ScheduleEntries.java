...
public class ScheduleEntries {
    ...
    @XmlElement(name = Naming.SCHEDULEENTRY_SN, required = true)
    protected List<String> scheduleEntry;

    public String toString() {
    	StringBuilder sbld = new StringBuilder();
    	sbld.append("scheduleEntry:");
    	boolean flag = false;
    	for (String sce : scheduleEntry) {
    		if(flag) sbld.append(", ");
    		else flag = true;
...
//        }
    ...
    public void addScheduleEntry(String sch) {
    	if (scheduleEntry == null) {
    		scheduleEntry = new ArrayList<String>();
        }
    	this.scheduleEntry.add(sch);
    }
