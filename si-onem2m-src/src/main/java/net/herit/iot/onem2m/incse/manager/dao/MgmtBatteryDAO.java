...
public class MgmtBatteryDAO extends ResourceDAO implements DAOInterface {
	
	private Logger log = LoggerFactory.getLogger(MgmtBatteryDAO.class);

	public MgmtBatteryDAO(OneM2mContext context) {
		super(context);
	}
