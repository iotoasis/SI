...
//	public final static String SCHEMA_LOCATION = "CDT-battery-v1_6_0.xsd";
	public final static String SCHEMA_LOCATION = "CDT-battery-v2_7_0.xsd";

    @XmlElement(name = Naming.BATTERYLEVEL_SN)
    @XmlSchemaType(name = "unsignedInt")
//    protected long batteryLevel;
    protected Long batteryLevel;
    //@XmlElement(required = true)
    @XmlElement(name = Naming.BATTERYSTATUS_SN, required = true)
