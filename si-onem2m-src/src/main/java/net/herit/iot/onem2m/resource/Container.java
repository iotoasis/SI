...
@XmlType(name = "", propOrder = {
  ...
  //  "latest",   deleted in CDT-2.7.0
  //  "oldest",	  deleted in CDT-2.7.0 	
    "childResource",
...
//			}
			...
			if (this.disableRetrieval != null) {		// added in CDT-2.7.0 
				throw new OneM2MException(RESPONSE_STATUS.INVALID_ARGUMENTS, "'disableRetrieval' is NP on UPDATE operation");
			}
		}
