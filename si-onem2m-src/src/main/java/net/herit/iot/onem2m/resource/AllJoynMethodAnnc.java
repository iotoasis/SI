 ...
 *             &lt;element ref="{http://www.onem2m.org/xml/protocols}allJoynMethodCallAnnc"/>
 *           &lt;/choice>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/extension>
...
@XmlRootElement(name = Naming.ALLJOYNMETHODANNC_SN)
public class AllJoynMethodAnnc
    extends AnnouncedFlexContainerResource
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "allJoynMethodCallAnnc", namespace = "http://www.onem2m.org/xml/protocols", type = AllJoynMethodCallAnnc.class)
    })
