	...
	public void validate(OPERATION operation) throws OneM2MException {
		...
		if (operation.equals(OPERATION.CREATE)) {	// CREATE 요청에 대한 데이터 유효성 체크
			...
			if (this.collectingEntityID == null) {				
				throw new OneM2MException(RESPONSE_STATUS.INVALID_ARGUMENTS, "collectingEntityID is NP on CREATE");				
			}
			if (this.collectedEntityID == null) {				
				throw new OneM2MException(RESPONSE_STATUS.INVALID_ARGUMENTS, "collectedEntityID is NP on CREATE");				
			}
			if (this.statsRuleStatus == null) {				
				throw new OneM2MException(RESPONSE_STATUS.INVALID_ARGUMENTS, "statsRuleStatus is NP on CREATE");				
			}
			if (this.statModel == null) {				
				throw new OneM2MException(RESPONSE_STATUS.INVALID_ARGUMENTS, "statModel is NP on CREATE");				
			}
