...
import net.herit.iot.onem2m.incse.manager.dao.GenericInterworkingServiceDAO;
...
public class GenericInterworkingServiceManager extends AbsManager {
	...
	public GenericInterworkingServiceManager(OneM2mContext context) {
	...
	public void notification(Resource parentRes, Resource reqRes, Resource orgRes, OPERATION op) throws OneM2MException {
		Document reqDoc = reqRes == null? null : Document.parse( ((GenericInterworkingServiceDAO)getDAO()).resourceToJson(reqRes));
		Document orgDoc = orgRes == null? null : Document.parse( ((GenericInterworkingServiceDAO)getDAO()).resourceToJson(orgRes));
	...
	public DAOInterface getDAO() {
		return new GenericInterworkingServiceDAO(context);
	}

	@Override
	public Class<?> getResourceClass() {
		return GenericInterworkingService.class;
	}

	@Override
	public XMLConvertor<?> getXMLConveter() throws OneM2MException {
		return ConvertorFactory.getXMLConvertor(GenericInterworkingService.class, GenericInterworkingService.SCHEMA_LOCATION);
	}

	@Override
	public JSONConvertor<?> getJSONConveter() throws OneM2MException {
		return ConvertorFactory.getJSONConvertor(GenericInterworkingService.class, GenericInterworkingService.SCHEMA_LOCATION);
	}
