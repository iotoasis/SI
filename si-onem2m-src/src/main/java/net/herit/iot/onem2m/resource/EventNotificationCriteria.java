...
@XmlType(name = "eventNotificationCriteria", propOrder = {
    ...
    "missingData"				// added in CDT-2.7.0
})
public class EventNotificationCriteria {
    ...
    // })
    @XmlElement(name = Naming.NOTIFICATIONEVENTTYPE_SN)
    protected List<Integer> notificationEventType;
    @XmlElement(name = Naming.MISSINGDATA_SN)
    protected MissingData missingData;		// added in CDT-2.7.0
...
//    	}
     ...
     *     
     */
    public void setMissingData(MissingData value) {
