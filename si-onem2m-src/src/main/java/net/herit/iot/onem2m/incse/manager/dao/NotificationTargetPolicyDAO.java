...
public class NotificationTargetPolicyDAO extends ResourceDAO implements
		DAOInterface {

	private Logger log = LoggerFactory.getLogger(NotificationTargetPolicyDAO.class);

	public NotificationTargetPolicyDAO(OneM2mContext context) {
		super(context);
	}
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			DaoJSONConvertor<NotificationTargetPolicy> jc = (DaoJSONConvertor<NotificationTargetPolicy>)ConvertorFactory.getDaoJSONConvertor(NotificationTargetPolicy.class, NotificationTargetPolicy.SCHEMA_LOCATION);
			return jc.marshal((NotificationTargetPolicy)res);
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, 
				(DaoJSONConvertor<NotificationTargetPolicy>)ConvertorFactory.getDaoJSONConvertor(NotificationTargetPolicy.class, NotificationTargetPolicy.SCHEMA_LOCATION), rc);
	}
