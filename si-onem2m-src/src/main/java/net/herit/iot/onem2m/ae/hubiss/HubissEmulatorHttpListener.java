...
public class HubissEmulatorHttpListener implements HttpServerListener {
	...
	private Logger log = LoggerFactory.getLogger(HubissEmulatorHttpListener.class);

	private AEControllerEx aeController; 
	private NotiHandlerInterface notiHandler; 
	
	public HubissEmulatorHttpListener(String ip, int port, AEControllerEx aeController, NotiHandlerInterface notiHandler) {
		try {
