...
public class RemoteCSEAnncDAO extends ResourceDAO implements DAOInterface {
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			JSONConvertor<RemoteCSEAnnc> jc = (JSONConvertor<RemoteCSEAnnc>)ConvertorFactory.getJSONConvertor(RemoteCSEAnnc.class, RemoteCSEAnnc.SCHEMA_LOCATION);
...
//		
//		return this.retrieve(URI_KEY, uri, new JSONConvertor<RemoteCSEAnnc>(RemoteCSEAnnc.class), rc);
//		
//	}
//
//	@Override
...
//		
//		return this.retrieve("resourceID", id, new JSONConvertor<RemoteCSEAnnc>(RemoteCSEAnnc.class), rc);
//		
//	}
//	
//	@Override
...
//	}
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		...
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, ConvertorFactory.getJSONConvertor(RemoteCSEAnnc.class, RemoteCSEAnnc.SCHEMA_LOCATION), rc);
