...
public class Enums {
	...
	public enum CONTENT_TYPE {
		...
		CBOR(11, "application/cbor"),			// added in 2017-04-21
		RES_XML(3, "application/vnd.onem2m-res+xml"),
		RES_JSON(4, "application/vnd.onem2m-res+json"),
		RES_CBOR(12, "application/vnd.onem2m-res+cbor"),	// added in 2017-04-21
		NTFY_XML(5, "application/vnd.onem2m-ntfy+xml"),
		NTFY_JSON(6, "application/vnd.onem2m-ntfy+json"),
		NTFY_CBOR(13, "application/vnd.onem2m-ntfy+cbor"),	// added in 2017-04-21
		ATTRS_XML(7, "application/vnd.onem2m-attrs+xml"),
		ATTRS_JSON(8, "application/vnd.onem2m-attrs+json"),
		// added in 2017-04-21 as below requestPrimitive and responsePrimitve at once.
		REQ_PRIM_XML(21, "application/vnd.onem2m-preq+xml"),
		REQ_PRIM_JSON(22, "application/vnd.onem2m-preq+json"),
		REQ_PRIM_CBOR(23, "application/vnd.onem2m-preq+cbor"),
		RSP_PRIM_XML(24, "application/vnd.onem2m-prsp+xml"),
		RSP_PRIM_JSON(25, "application/vnd.onem2m-prsp+json"),
		RSP_PRIM_CBOR(26, "application/vnd.onem2m-prsp+cbor"),
