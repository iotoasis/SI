...
public class MgmtDeviceCapabilityDAO extends ResourceDAO implements DAOInterface {
	
	private Logger log = LoggerFactory.getLogger(MgmtDeviceCapabilityDAO.class);

	public MgmtDeviceCapabilityDAO(OneM2mContext context) {
		super(context);
	}
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			DaoJSONConvertor<DeviceCapability> jc = (DaoJSONConvertor<DeviceCapability>)ConvertorFactory.getDaoJSONConvertor(DeviceCapability.class, DeviceCapability.SCHEMA_LOCATION);
			return jc.marshal((DeviceCapability)res);
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		...
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, 
				(DaoJSONConvertor<DeviceCapability>)ConvertorFactory.getDaoJSONConvertor(DeviceCapability.class, DeviceCapability.SCHEMA_LOCATION), rc);
