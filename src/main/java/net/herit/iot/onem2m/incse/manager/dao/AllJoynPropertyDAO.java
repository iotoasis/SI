...
public class AllJoynPropertyDAO extends ResourceDAO implements DAOInterface {

	private Logger log = LoggerFactory.getLogger(AllJoynPropertyDAO.class);
	
	public AllJoynPropertyDAO(OneM2mContext context) {
		super(context);
	}
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			DaoJSONConvertor<AllJoynProperty> jc = (DaoJSONConvertor<AllJoynProperty>)ConvertorFactory.getDaoJSONConvertor(AllJoynProperty.class, AllJoynProperty.SCHEMA_LOCATION);
			return jc.marshal((AllJoynProperty)res);
	...
	public void create(Resource resource) throws OneM2MException {
		...
		((AllJoynProperty) resource).setStateTag(0);
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		...
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, 
				ConvertorFactory.getDaoJSONConvertor(AllJoynProperty.class, AllJoynProperty.SCHEMA_LOCATION), rc);
