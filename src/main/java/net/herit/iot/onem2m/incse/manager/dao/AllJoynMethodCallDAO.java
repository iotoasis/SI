...
public class AllJoynMethodCallDAO extends ResourceDAO implements DAOInterface {
	
	private Logger log = LoggerFactory.getLogger(AllJoynMethodCallDAO.class);

	public AllJoynMethodCallDAO(OneM2mContext context) {
		super(context);
	}
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			DaoJSONConvertor<AllJoynMethodCall> jc = (DaoJSONConvertor<AllJoynMethodCall>)ConvertorFactory.getDaoJSONConvertor(AllJoynMethodCall.class, AllJoynMethodCall.SCHEMA_LOCATION);
			return jc.marshal((AllJoynMethodCall)res);
	...
	public void create(Resource resource) throws OneM2MException {
		...
		((AllJoynMethodCall) resource).setStateTag(0);
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		...
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, 
				ConvertorFactory.getDaoJSONConvertor(AllJoynMethodCall.class, AllJoynMethodCall.SCHEMA_LOCATION), rc);
