...
import net.herit.iot.onem2m.incse.manager.dao.MgmtAreaNwkDeviceInfoDAO;
import net.herit.iot.onem2m.resource.AreaNwkDeviceInfo;
import net.herit.iot.onem2m.resource.Resource;


public class MgmtAreaNwkDeviceInfoManager extends AbsManager {
	
	static String ALLOWED_PARENT = "node";  
	static RESOURCE_TYPE RES_TYPE = RESOURCE_TYPE.MGMT_OBJ; 
	
	private Logger log = LoggerFactory.getLogger(MgmtAreaNwkDeviceInfoManager.class);

	private static final String TAG = MgmtAreaNwkDeviceInfoManager.class.getName();

	public MgmtAreaNwkDeviceInfoManager(OneM2mContext context) {
...
//	}
	...
	public DAOInterface getDAO() {
		return new MgmtAreaNwkDeviceInfoDAO(context);
	}

	@Override
	public Class<?> getResourceClass() {
		return MgmtAreaNwkDeviceInfoManager.class;
	}

	@Override
	public XMLConvertor<?> getXMLConveter() throws OneM2MException {
		return ConvertorFactory.getXMLConvertor(AreaNwkDeviceInfo.class, AreaNwkDeviceInfo.SCHEMA_LOCATION);
	}

	@Override
	public JSONConvertor<?> getJSONConveter() throws OneM2MException {
		return ConvertorFactory.getJSONConvertor(AreaNwkDeviceInfo.class, AreaNwkDeviceInfo.SCHEMA_LOCATION);
	}
	
	@Override
	public void updateResource(Resource resource, OneM2mRequest req) throws OneM2MException {
		AreaNwkDeviceInfo res =  (AreaNwkDeviceInfo)resource;
