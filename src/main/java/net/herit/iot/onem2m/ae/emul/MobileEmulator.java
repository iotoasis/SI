...
public class MobileEmulator {
	...
	private Logger log = LoggerFactory.getLogger(MobileEmulator.class);
	...
	private String deviceSn = "00000000000000000303"; 
	private String mac = "";
	private String ctn = "01012345676";
	private String deviceType = "adn";
	private String iccId = "C244C1";
	
	private String ip;
	private int port;
	
	public MobileEmulator(String ip, int port) {
		try {
	...
	public void start() {
		...
		try {
			...
			// 컨테이너 생성
			this.temperatureCnt = aeController.doCreateContainer(ae.getUri(), ae.getAEID(), Constants.CNT_TEMPERATURE, acpIds, true);
	...
	public static void main(String[] args) throws Exception {
		new MobileEmulator(Constants.DEVICE_IP, Constants.DEVICE_PORT).start();		
	}
