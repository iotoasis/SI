...
//	public static final String SCHEMA_LOCATION = "CDT-execInstance-v1_6_0.xsd";
	public static final String SCHEMA_LOCATION = "CDT-execInstance-v2_7_0.xsd";
	
    //@XmlElement(required = true)
    @XmlElement(name = Naming.EXECSTATUS_SN)
    protected Integer execStatus;
    //@XmlElement(required = true)
    @XmlElement(name = Naming.EXECRESULT_SN)
    protected Integer execResult;
    @XmlElement(name = Naming.EXECDISABLE_SN)
    protected Boolean execDisable;
    //@XmlElement(required = true)
    @XmlElement(name = Naming.EXECTARGET_SN)
