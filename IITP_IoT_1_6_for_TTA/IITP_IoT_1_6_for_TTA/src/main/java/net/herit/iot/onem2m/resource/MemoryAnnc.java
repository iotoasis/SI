...
@XmlRootElement(name = Naming.MEMORYANNC_SN)
...
//	public final static String SCHEMA_LOCATION = "CDT-memory-v1_6_0.xsd";
	public final static String SCHEMA_LOCATION = "CDT-memory-v2_7_0.xsd";

    @XmlElement(name = Naming.MEMAVAILABLE_SN)
    @XmlSchemaType(name = "unsignedLong")
    protected Integer memAvailable;
    @XmlElement(name = Naming.MEMTOTAL_SN)
    @XmlSchemaType(name = "unsignedLong")
