...
//	public static final String SCHEMA_LOCATION = "CDT-AE-v1_6_0.xsd";
	public static final String SCHEMA_LOCATION = "CDT-AE-v2_7_0.xsd";
	...
	public static final Set<String> OA = new HashSet<String>(
		Arrays.asList(Naming.APPNAME_SN,
					//	Naming.APPID_SN,   blocked in 2017-06-28
						Naming.AEID_SN,
						Naming.POINTOFACCESS_SN,
						Naming.ONTOLOGYREF_SN,
					//	Naming.REQUESTREACHABILITY_SN,	blocked in 2017-06-28
						Naming.NODELINK_SN
		)
	);
	...
	@XmlElements({
        ...
        @XmlElement(name = "timeSeriesAnnc", namespace = "http://www.onem2m.org/xml/protocols", type = TimeSeriesAnnc.class),
        @XmlElement(name = "trafficPatternAnnc", namespace = "http://www.onem2m.org/xml/protocols", type = TrafficPatternAnnc.class),
