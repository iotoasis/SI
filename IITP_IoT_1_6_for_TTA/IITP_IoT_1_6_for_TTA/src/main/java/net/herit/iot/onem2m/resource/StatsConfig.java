...
@XmlRootElement(name = Naming.STATSCONFIG_SN)
...
//	public final static String SCHEMA_LOCATION = "CDT-statsConfig-v1_6_0.xsd";
	public final static String SCHEMA_LOCATION = "CDT-statsConfig-v2_7_0.xsd";
	
    //@XmlElement(required = true)
    //@XmlElement(name = Naming.CREATOR_SN, required = true)  removed 'required = true' in CDT-2.7.0
