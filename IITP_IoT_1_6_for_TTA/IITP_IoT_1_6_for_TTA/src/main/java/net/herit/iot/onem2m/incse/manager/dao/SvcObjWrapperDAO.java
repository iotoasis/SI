...
public class SvcObjWrapperDAO extends ResourceDAO implements DAOInterface {
	
	private Logger log = LoggerFactory.getLogger(SvcObjWrapperDAO.class);

	public SvcObjWrapperDAO(OneM2mContext context) {
		super(context);
	}
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			DaoJSONConvertor<SvcObjWrapper> jc = (DaoJSONConvertor<SvcObjWrapper>)ConvertorFactory.getDaoJSONConvertor(SvcObjWrapper.class, SvcObjWrapper.SCHEMA_LOCATION);
			return jc.marshal((SvcObjWrapper)res);
	...
	public void create(Resource resource) throws OneM2MException {
		...
		((SvcObjWrapper) resource).setStateTag(0);
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		...
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, 
				ConvertorFactory.getDaoJSONConvertor(SvcObjWrapper.class, SvcObjWrapper.SCHEMA_LOCATION), rc);
