...
public class AllJoynAppDAO extends ResourceDAO implements DAOInterface {

private Logger log = LoggerFactory.getLogger(AllJoynAppDAO.class);
	
	public AllJoynAppDAO(OneM2mContext context) {
		super(context);
	}
	...
	public String resourceToJson(Resource res) throws OneM2MException {
		try {
			...
			DaoJSONConvertor<AllJoynApp> jc = (DaoJSONConvertor<AllJoynApp>)ConvertorFactory.getDaoJSONConvertor(AllJoynApp.class, AllJoynApp.SCHEMA_LOCATION);
			return jc.marshal((AllJoynApp)res);
	...
	public void create(Resource resource) throws OneM2MException {
		...
		((AllJoynApp) resource).setStateTag(0);
	...
	public Resource retrieve(String id, RESULT_CONT rc) throws OneM2MException {
		...
		return retrieve(OneM2mUtil.isUri(id) ? URI_KEY : RESID_KEY, id, 
				ConvertorFactory.getDaoJSONConvertor(AllJoynApp.class, AllJoynApp.SCHEMA_LOCATION), rc);
