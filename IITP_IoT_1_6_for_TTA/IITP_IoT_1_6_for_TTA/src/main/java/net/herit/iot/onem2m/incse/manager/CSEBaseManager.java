...
public class CSEBaseManager extends AbsManager {
	...
	public void createIfNotExist() throws OneM2MException {
		...
		if (csebase == null) {
			...
			//csebase.addSupportedResourceType(RESOURCE_TYPE.FLEXCONTAINER.Value());						// added in 2017-03-13, blocked in 2017-10-24 for TTA
			csebase.addSupportedResourceType(RESOURCE_TYPE.SCHEDULE.Value());						// added in 2017-03-13
			//csebase.addSupportedResourceType(RESOURCE_TYPE.NOTIFICATIONTARGETPOLICY.Value());		// added in 2017-03-13, blocked in 2017-10-24 for TTA
