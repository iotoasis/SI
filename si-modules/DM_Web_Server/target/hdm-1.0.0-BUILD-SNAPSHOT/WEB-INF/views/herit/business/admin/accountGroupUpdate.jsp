...
<head>
	...
	<script type="text/javaScript" language="javascript">
		...
		function fnUpdate(){
			...
			var myForm				 = document.getElementById("myForm");
			myForm.action           = "<c:url value='/admin/accountGroup/update.do'/>";
		   	myForm.submit();
		}
		/* ********************************************************
		 * 최초 실행
...
<div id="wrapper">
	...
	<div class="position_text">
		<div class="wrap_div">
			...
			<span>
				...
				< <a href="javascript:fnDetail()">권한 그룹 정보</a>
				< 권한 그룹 수정
			</span>
		</div>
	</div>
	...
	<div class="container_wrap">
		...
		<form id="myForm" name="myForm" action="<c:url value='/admin/accountGroup/list.do'/>" method="post">
			...
			<input type="hidden" id="id" name="id" value="${accountGroupVO.id}" />
				...
				<div class="tr first">
					...
					<div class="td">
						<div class="td_content">
							<input type="text" id="groupCode" name="groupCode" value="${accountGroupVO.groupCode}" class="i_text focus_input al readonly" size="40" readonly />
						</div>
					</div>
				</div>
				<div class="tr">
