...
<!-- parameters: ${param.parameterList} -->
					...
					<div class="ibox float-e-margins">
						<div class="ibox-title">
							...
							<h3 class="dsslg-res-1-time" style="float: right; margin-top: -16px;"></h3>
						...
						<div class="ibox-content" style="height: 180px;">
							<div class="row">
								<div class="col-lg-3" style="margin-top:10px;">
									...
									<span class="dsslg-res-1-value font-bold" style="margin-left: 5px; margin-right: 10px; font-size: 80px;">-</span> 
									<span class="dsslg-res-1-unit" style="font-size: 20px; position: fixed; top: inherit; height: 80px; line-height: 80px;">-</span>
								</div>
								<div class="col-lg-9">
