...
<head>
    ...
    <script type="text/javaScript" language="javascript">
		...
		function initUI() {
			...
			$("#side-menu_statistics ul li:eq(1)").addClass("active");
		}
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-sm-4">
				...
				<ol class="breadcrumb">
					...
					<li>통계</li>
					<li class="active"><strong>사용 통계</strong></li>
				</ol>
			</div>
		</div>
						...
						<div class="ibox-content">
							...
							<table id="stat_table" class="table table-bordered table-hover">
								<thead>
									<tr>
										<th width="25%">기간</th>
										<th width="25%">에러메시지수</th>
										<th width="25%">제어메시지수</th>
										<th width="25%">펌웨어업데이트메시지수</th>
									</tr>
								</thead>
								<tbody>
									<tr>
