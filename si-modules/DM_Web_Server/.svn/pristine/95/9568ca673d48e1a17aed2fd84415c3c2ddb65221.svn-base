...
/*****************************MOBILE******************************/	
	//HERE MOBILE DEVICEPROFILE LIST	
	function hdb_get_deviceProfile_list(context, loading) {
		console.log("hdb_get_deviceProfile_list called context: ");
		console.log(context);
		
		$.ajax({
			  type: "GET",
			  dataType: "json",
			  url: "/mobile/api/hdp/deviceModel/deviceProfile/list.do",
			  contentType: "application/json",
			  data: context.param,
			  context: context
			})
		...
		/*$.ajax({
			  type: "GET",
			  dataType: "json",
			  url: "/hdm/api/hdp/deviceModel/deviceProfile/list.do",
			  contentType: "application/json",
			  data: context.param,
			  context: context
			})
	...
	//HERE MOBILE DEVICECONTROLDATA LIST (CHECKDEVICECONTROL)
	function hdb_get_deviceMoData_list(context, loading) {
		console.log("hdb_get_deviceMoData_list called context: ");
		console.log(context);
		
		$.ajax({
			  type: "GET",
			  dataType: "json",
			  url: "/mobile/api/hdm/device/moData/list.do",
			  contentType: "application/json",
			  data: context.param,
			  context: context
			})
	...
	function hdb_get_deviceMoData_info(context, loading) {
		console.log("hdb_get_deviceMoData_info called context: ");
		console.log(context);
		
		$.ajax({
			  type: "GET",
			  dataType: "json",
			  url: "/mobile/api/hdm/device/deviceMoData/get.do",
			  contentType: "application/json",
			  data: context.param,
			  context: context
			})
	...
	//HERE MOBILE SELECT DEIVCEID FOR DEVICEMODATAINFO
	function hdb_searchDevice_for_select(context, loading) {
		console.log("hdb_searchDevice_for_select called context:");
		console.log(context);
		
		$.ajax({
		  type: "GET",
		  dataType: "json",
		  url: "/mobile/api/hdm/device/deviceIdSelect/get.do",
		  contentType: "application/json",
		  data: context.param,
		  context: context
		})
	...
	function hdb_update_deviceMoData(context, loading) {
		console.log("hdb_update_deviceMoData called context: ");
		console.log(context);
		
		$.ajax({
		  type: "GET",
		  dataType: "json",
		  url: "/mobile/api/hdm/device/deviceMoData/update.do",
		  contentType: "application/json",
		  data: context.param,
		  context: context
		})
	...
	//HERE MOBILE STATUSWEEKAVG LIST
	function hdh_statusWeekAvg_list(context, loading) {
		console.log("hdh_statusWeekAvg_list called context: ");
		console.log(context);
		
		$.ajax({
			  type: "GET",
			  dataType: "json",
			  url: "/mobile/api/hdh/history/statusWeekAvg/list.do",
			  contentType: "application/json",
			  data: context.param,
			  context: context
			})
	...
	//HERE MOBILE STATUSTIMEAVG LIST
	function hdh_stautsTimeAvg_list(context, loading) {
		console.log("hdh_stautsTimeAvg_list called context: ");
		console.log(context);
		
		$.ajax({
			  type: "GET",
			  dataType: "json",
			  url: "/mobile/api/hdh/history/statusTimeAvg/list.do",
			  contentType: "application/json",
			  data: context.param,
			  context: context
			})
