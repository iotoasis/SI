	...
	//context: {"deviceId":deviceInfo.deviceId, 
	//			"resourceUris":[<resUri>, <resUri>, <resUri>, ...], 
	//			"e":[ {"n":<resUri>}, {"n":<resUri>}, {"n":<resUri>}, ... ], 
	//			"handler": executeResultHandler};
	...
	/** oneM2M 서버에서 디바이스 aeId 검색 */
	function dm_discovery(context, loading) {
		console.log("dm_discovery called context:");
		console.log(context);
		...
		$.ajax({
			...
			dataType: "json",
			contentType: "application/json",
			url: "/hdm/api/gw/device/discovery.do",
			//data: JSON.stringify({"e":e}),
