...
function initUI2() {
	...
	$(".upgradeCheckbox").on('ifChecked ifUnchecked', function() {
...
function updateCheckboxStatus() {
	...
	var selectedVersion = $("#search_firmwareVersion").val();
...
function executeUpgrade() {
	...
	var firmwareId = $("#search_package").val();
