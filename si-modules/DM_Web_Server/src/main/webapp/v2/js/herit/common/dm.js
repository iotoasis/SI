	...
	***************************************************/
	...
	function dm_firmware_upload(form){
		form.ajaxSubmit({ 
			url: '/hdm/api/hdp/firmware/upload.do', 
			dataType: 'json', 
			processData: false,
	...
	function dm_reboot_tr069(context, loading)
	{
	...
	function dm_read(context, loading)
	{
		...
		console.log(context);
		console.log("[ TEST CHECK POINT -1 ]");
		if (loading == true)
		{
			ajaxStart();
		}
