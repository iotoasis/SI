				...
				<div class="content_wrap top_pad_30">
							...
							<div class="search_form_only">
								...
								<div class="search_form_wrap">
									...
									<div class="search_form_div">
										...
										<span>패키지</span>
										<select name="packageName" id="search_packageName">
											<option value="">전체</option>
										</select>
										<input name="Submit"
											type="submit" class="search_bt_green" id="btnSearchHistory" value="펌웨어이력 검색" />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="device_list_wrap_100py2">
						...
						<table border="0" cellspacing="0" cellpadding="0"
							...
							<tbody>
								<tr>
									<td colspan="8">디바이스를 선택한 후 펌웨어 업그레이드 이력을 검색하세요.</td>
								</tr>
							</tbody>
						</table>
