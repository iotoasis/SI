...
<head>
	...
	<script language="javascript" src="<c:url value="/v2/js/herit/history.js" />"></script>
	<script language="javascript" src="<c:url value="/v2/js/herit/historyFirmware.js" />"></script>
    ...
    <script type="text/javaScript" language="javascript">
		...
		function initUI() {
			...
			$("#side-menu_history ul li:eq(2)").addClass("active");
		}
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-sm-12">
				...
				<ol class="breadcrumb">
					...
					<li>이력</li>
					<li class="active"><strong>펌웨어 업그레이드 이력</strong></li>
				</ol>
			</div>
		</div>
				...
				<div class="col-lg-12">
					<div class="ibox float-e-margins">
						<div class="ibox-title">
							<h3 class="no-margins">펌웨어 업그레이드 이력</h3>
						</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<label class="form-inline">
										...
										패키지&nbsp;
										<div class="input-group">
											<select name="packageName" id="search_packageName" class="form-control input-sm" style="min-width:260px;">
												<option value="">전체</option>
											</select>
											<span class="input-group-btn">
												<button type="button" id="btnSearchHistory" class="btn btn-sm btn-primary"> 펌웨어 업그레이드 이력 검색</button>
											</span>
										</div>
									</label>
								</div>
							...
							<table class="table table-bordered table-hover" id="history_table">
								<thead>
									<tr>
										...
										<th id="hd_version">버전</th>
										<th id="hd_status" class="history_manual_renderer">업그레이드 상태</th>
										<th id="hd_statusTime">시간</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td colspan="6">디바이스를 선택한 후 펌웨어 업그레이드 이력을 검색하세요.</td>
									</tr>
								</tbody>
							</table>
