...
<head>
	...
	<script language="javascript" src="<c:url value="/v2/js/herit/historyStatus.js" />"></script>
    ...
    <script type="text/javaScript" language="javascript">
		...
		function initUI() {
			...
			$("#side-menu_history ul li:eq(3)").addClass("active");
		}
		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-sm-4">
				...
				<ol class="breadcrumb">
					...
					<li>이력</li>
					<li class="active"><strong>상태 이력</strong></li>
				</ol>
			</div>
		</div>
					...
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-sm-12">
									<label class="form-inline">
										디바이스 모델&nbsp;
										<select name="deviceModel" id="search_deviceModelId" class="form-control input-sm">
										...
										<div class="input-group">
											...
											<span class="input-group-btn">
												<button type="button" id="btnSearchDevice" class="btn btn-sm btn-primary" > 조회</button>
											</span>
										</div>
									</label>
								</div>
								...
								<div class="col-sm-12">
									<label class="form-inline">
										...
										<div class="input-group">
											...
											<span class="input-group-btn">
												<button type="button" id="btnSearchHistory" class="btn btn-sm btn-primary"> 상태이력 검색</button>
											</span>
										</div>
									</label>
								</div>
							...
							<table class="table table-bordered table-hover" id="history_table">
								...
								<tbody>
									<tr>
										<td colspan="6">디바이스를 선택한 후 상태이력을 검색하세요.</td>
									</tr>
								</tbody>
							</table>
