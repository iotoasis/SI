...
<!-- parameters: ${param.parameterList} -->
					...
					<div class="ibox float-e-margins">
						<div class="ibox-title">
							...
							<h3 class="dsslg_mem-res-1-time" style="float: right; margin-top: -16px;"></h3>
							...
							<h3 id="h3_total_mem" style="float: right; margin-right: 15px; margin-top: -16px;"></h3>
							...
							<h5 style="float: right; margin-top: -16px;">전체 메모리 :&nbsp;</h5>
							
						</div>
						<div class="ibox-content" style="height: 180px;">
							<div class="row">
								<div class="col-lg-3" style="margin-top:10px;">
									<!-- <div class="dsslg_mem-res-1-name" style="font-size: 15px; margin-left: 15px;">-</div> -->
									<span class="dsslg_mem-res-1-value font-bold" style="margin-left: 5px; margin-right: 10px; font-size: 80px;">-</span> 
									<span class="dsslg_mem-res-1-unit" style="font-size: 20px; position: fixed; top: inherit; height: 80px; line-height: 80px;">-</span>
								</div>
								<div class="col-lg-9">
									<div class="dsslg_mem-chart" style="width: 100%; height: 155px;">																		
