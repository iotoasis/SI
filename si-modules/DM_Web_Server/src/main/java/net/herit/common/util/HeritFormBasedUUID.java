...
public class HeritFormBasedUUID implements Serializable {
    /*
     ...
     */
    private HeritFormBasedUUID(byte[] data) {
        long msb = 0;
        long lsb = 0;
        for (int i = 0; i < 8; i++)
     ...
     * @param leastSigBits
     */
    public HeritFormBasedUUID(long mostSigBits, long leastSigBits) {
     ...
     */
    public static HeritFormBasedUUID randomUUID() {
        ...
        return new HeritFormBasedUUID(randomBytes);
    }
     ...
     */
    public static HeritFormBasedUUID nameUUIDFromBytes(byte[] name) {
        MessageDigest md;
        try {
        ...
        return new HeritFormBasedUUID(md5Bytes);
    }
     ...
     */
    public static HeritFormBasedUUID fromString(String name) {
        ...
        return new HeritFormBasedUUID(mostSigBits, leastSigBits);
    }
    ...
    public boolean equals(Object obj) {
    	...
    	if (!(obj instanceof HeritFormBasedUUID))
            return false;
        if (((HeritFormBasedUUID) obj).variant() != this.variant())
            return false;
        HeritFormBasedUUID id = (HeritFormBasedUUID) obj;
     ...
     */
    public int compareTo(HeritFormBasedUUID val) {
