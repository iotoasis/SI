 ...
 */
public class PageTemperature extends PageHandler implements android.view.View.OnClickListener {
    ...
    private void receiveData(){
        ...
        while( !Thread.interrupted() || isObserving ) {
            try {
                ...
                if( super.getValue(xml,"cr").equals("temperature") ){
                    Log.e(TAG, value);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.control_temperature);

        button_cancel = (Button) findViewById(R.id.button_temperature_a_cancel);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_temperature_a_cancel:
                stop_observe();
                finish();
                break;
            default:
