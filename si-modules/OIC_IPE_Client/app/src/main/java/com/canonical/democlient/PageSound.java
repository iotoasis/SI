 ...
 */
public class PageSound extends PageHandler implements android.view.View.OnClickListener {
    ...
    private void receiveData(){
        ...
        while( !Thread.interrupted() || isObserving ) {
            try {
                ...
                if( super.getValue(xml,"cr").equals("sound") ){
                    Log.e(TAG, value);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.control_sound);

        button_cancel = (Button) findViewById(R.id.button_sound_a_cancel);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_sound_a_cancel:
                stop_observe();
                finish();
                break;
            default:
